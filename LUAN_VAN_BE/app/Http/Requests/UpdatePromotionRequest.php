...
class UpdatePromotionRequest extends FormRequest
{
    ...
    {
        $promotionId = $this->route('id'); // Lấy ID khuyến mãi từ route model binding
        ...
        return [
            ...
            'type' => ['sometimes', 'required', Rule::in(['FIXED_DISCOUNT', 'PERCENT_DISCOUNT'])],
            'discount_value' => 'sometimes|required|numeric|min:0',
            // max_discount_amount: required_if nếu type được gửi và là PERCENT_DISCOUNT
            'max_discount_amount' => 'nullable|numeric|min:0|required_if:type,PERCENT_DISCOUNT',
            'min_order_amount' => 'nullable|numeric|min:0',
            'usage_limit_per_user' => 'nullable|integer|min:0',
            'total_usage_limit' => 'nullable|integer|min:0',
            'apply_to_product_type' => ['nullable', Rule::in(['TICKET', 'COMBO', 'ALL'])],
