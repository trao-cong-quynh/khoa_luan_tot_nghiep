...
class TheaterRoomRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'cinema_id.integer' => 'ID rạp chiếu phải là số nguyên.',
            ...
            'room_name.unique' => 'Tên phòng đã tồn tại trong rạp được chọn.',

            'room_type.required' => 'Vui lòng chọn loại phòng chiếu.',
            'room_type.string' => 'Loại phòng chiếu phải là chuỗi ký tự.',
            'room_type.in' => 'Loại phòng chiếu chỉ được chọn là "thường" hoặc "vip".',
